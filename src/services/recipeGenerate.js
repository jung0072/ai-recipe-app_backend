...
exports.openaiRecipeGenerateService = void 0;
...
const openaiRecipeGenerateService = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
Enjoy the Zucchini Orzo Salad with Pepperoncini Dressing as an easy, delicious side dish perfect for any occasion!`;
    ...
    try {
        ...
        $(simple_condition).each((index, element) => {
...
The markdown should contain the following information: title, total_yield, description, ingredients, instructions.`;
        ...
        class MyCustomHandler extends callbacks_1.BaseCallbackHandler {
            constructor(stream) {
                super();
                this.name = "MyCustomHandler";
                this.stream = stream;
...
exports.openaiRecipeGenerateService = openaiRecipeGenerateService;
